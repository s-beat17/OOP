...
/**
 * Абстрактный класс Диалогового окна Добавления/Редактирования данных покупателей
 */
public abstract class DialogEmploy extends JDialog {
    ...
    private JLabel ranLab = new JLabel("VIN");
     ...
     */
    public abstract void progress(LabTest parent);
     ...
     * @param parent Объект класса приложения
     */
    public abstract void init(LabTest parent);
     ...
     */
    public DialogEmploy(JFrame owner, LabTest parent, String title) {
...
// retarget the binding for released
    ...
    protected void checker(int i, JTextField field){
        Pattern r = Pattern.compile("^[а-яёА-ЯЁa-zA-Z0-9]{1,20}$");
